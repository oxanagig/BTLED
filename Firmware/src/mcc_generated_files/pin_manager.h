...
#define LED_DATA_TRIS               TRISA2
#define LED_DATA_LAT                LATA2
#define LED_DATA_PORT               RA2
#define LED_DATA_WPU                WPUA2
#define LED_DATA_ANS                ANSA2
#define LED_DATA_SetHigh()    do { LATA2 = 1; } while(0)
#define LED_DATA_SetLow()   do { LATA2 = 0; } while(0)
#define LED_DATA_Toggle()   do { LATA2 = ~LATA2; } while(0)
#define LED_DATA_GetValue()         RA2
#define LED_DATA_SetDigitalInput()    do { TRISA2 = 1; } while(0)
#define LED_DATA_SetDigitalOutput()   do { TRISA2 = 0; } while(0)

#define LED_DATA_SetPullup()    do { WPUA2 = 1; } while(0)
#define LED_DATA_ResetPullup()   do { WPUA2 = 0; } while(0)
#define LED_DATA_SetAnalogMode()   do { ANSA2 = 1; } while(0)
#define LED_DATA_SetDigitalMode()   do { ANSA2 = 0; } while(0)
